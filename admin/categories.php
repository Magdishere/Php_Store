	...
	if (isset($_SESSION['Username'])) {
		...
		if ($do == 'Manage') {
            ...
            <div class="container categories">
                ...
                <a href="categories.php?do=Add" class="btn btn-primary btn-add-cat"><i class="fa fa-plus"></i> Add New Category</a>
            </div>
            <?php 
                }else{
                    echo '<div class="container">';
                        echo '<div class="nice-message">There are no Categories to show</div>';
                        echo '<a href="categories.php?do=Add" class="btn btn-primary btn-add-cat"><i class="fa fa-plus"></i> Add New Category</a>';
                    echo '</div>';
            } ?>
                    ...
                    <form class="form-horizontal" action="?do=Insert" method="POST">
                        ...
                        <div class="form-group form-group-lg">
                            ...
                            <div class="col-sm-10 col-md-6">
                                <input type="text" name="name" class="form-control" autocomplete="off" required="required" placeholder="Enter Category Name"/>
                            </div>
                        </div>
                        <!-- End Name Field -->
                        ...
                        <div class="form-group form-group-lg">
                            ...
                            <div class="col-sm-10 col-md-6">
                                <input type="text" name="description" class="form-control" autocomplete="new-password" placeholder="Description Of Category" />
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-lg">
                            <div class="col-sm-offset-2 col-sm-10 col-md-6">
                                <input type="submit" value="Add Category" class="add-category-btn btn btn-primary btn-lg"/>
                            </div>
                        </div>
                        <!-- End Submit Field -->
                    </form>
                ...
                <div class="container">
                    <form class="form-horizontal" action="?do=Update" method="POST">
                        ...
                        <div class="form-group form-group-lg">
                            <label class="col-sm-2 control-label">Name</label>
                            <div class="col-sm-10 col-md-6">
                                <input type="text" name="name" class="form-control" required="required" placeholder="Enter Category Name" value="<?php echo $cat['Name'] ?>"/>
                            </div>
                        </div>
                        <!-- End Name Field -->
                        <!-- Start Description Field -->
                        ...
                        <div class="form-group form-group-lg">
                            <div class="col-sm-offset-2 col-sm-10 col-md-6">
                                <input type="submit" value="Edit Category" class="btn btn-primary btn-lg edit-sub-cat"/>
                                <?php echo "<a href='categories.php?do=Delete&catid=" . $cat['ID'] . "' class='confirm btn btn-primary btn-lg delete-sub-cat'>Delete</a>"; ?>
                            </div>
                        </div>
                        <!-- End Submit Field -->
                    </form>
